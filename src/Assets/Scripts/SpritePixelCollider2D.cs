...
public sealed class SpritePixelCollider2D : MonoBehaviour
{
    ...
    public void Start()
    {
        if (regenerationMode is RegenerationMode.Continuous or RegenerationMode.Automatic)
        {
            Regenerate();
        }
    }
    ...
    private void Update()
    {
        ...
        {
            case RegenerationMode.Continuous:
                Regenerate();
                break;
            case RegenerationMode.Manual:
            case RegenerationMode.Automatic:
                break;
        }
    }
